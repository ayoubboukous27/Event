...
# إضافة القناة مع الشعار الجديد
channel = ET.SubElement(tv, "channel", id="canal_plus_evenements_4k")
ET.SubElement(channel, "display-name").text = "Canal + Événements 4K"
ET.SubElement(channel, "icon", src="https://raw.githubusercontent.com/ayoubboukous27/Event/refs/heads/main/Picsart_26-03-21_17-41-51-504.png")
